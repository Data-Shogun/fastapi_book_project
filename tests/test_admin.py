...
def test_get_all_books_not_admin_user(monkeypatch, test_book):
    ...
    monkeypatch.setitem(app.dependency_overrides, get_current_user, override_get_current_user_regular)
...
def test_delete_book_not_admin_user(monkeypatch, test_book):
    """Using monkeypatch"""
    monkeypatch.setitem(app.dependency_overrides, get_current_user, lambda: {
        "username": "testuser",
